          ...
          case "user":
            return (
              <div className="wrapper">
                <header id="header">
                  <div className="column-4 branding">
                    <img src="images/Team logo.png" alt="team-logo" />
                  </div>
              ...
              <nav className="user-menu">
                <ul id="user-main-menu" className="menu-ul"style={{listStyleType: 'none', display: 'flex', justifyContent: 'center', padding: '20px'}} >
                  ...
                  <span className="amount" style={{fontFamily: "Roboto", fontSize: 18, padding: "8px", marginLeft: "0px"}}><span clasName="currencySymbol">$</span>0.00</span>
                </ul>
              </nav>
            </div>
          </header>
